  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: LandingResponsiveLayout(
        child: Column(
          children: [
            const AnimatedSection(child: BusinessDashboardHeroSection()),
            const SizedBox(height: 40),

            const AnimatedSection(child: BusinessDashboardFeaturesSection()),
            const SizedBox(height: 40),

            const AnimatedSection(child: BusinessDashboardCTASection()),
            const SizedBox(height: 40),
