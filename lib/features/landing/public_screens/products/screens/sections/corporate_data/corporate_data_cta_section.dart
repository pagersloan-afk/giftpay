...
class CorporateDataCTASection extends StatelessWidget {
  const CorporateDataCTASection({super.key});
...
class _CTAContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const Column(
      ...
      children: [
        Text(
          'Ready to simplify business connectivity?',
          style: TextStyle(
            fontFamily: 'SegoeUI',
            fontSize: 25,
            height: 1.2,
        ...
        SizedBox(height: 11),
        Text(
          'Create your GiftPay account and manage supported '
          'digital services from one secure platform built for '
          'modern businesses.',
          style: TextStyle(
            fontFamily: 'SegoeUI',
            fontSize: 14,
